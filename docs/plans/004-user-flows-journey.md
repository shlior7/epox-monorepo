...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│ STORE MANAGEMENT                                           [Disconnect Store]│
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│ Connected: WooCommerce - mystore.com              Status: ● Active           │
│ Last Sync: 2 hours ago                            Synced: 145 images         │
│                                                                              │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│ Filter: [All ▼]  [Synced]  [Pending]  [Not Generated]      Search: [_____] │
│                                                                              │
│ ┌─────────────────────────────────────────────────────────────────────────┐ │
│ │ Product              │ Generated │ Approved │ Synced │ Pending │ Actions │ │
│ ├─────────────────────────────────────────────────────────────────────────┤ │
│ │ Modern Oak Desk      │    8      │    5     │   3    │    2    │ [View] │ │
│ │ Velvet Sofa Blue     │    12     │    10    │   8    │    2    │ [View] │ │
│ │ King Bed Frame       │    4      │    4     │   4    │    0    │ [View] │ │
│ │ ...                  │   ...     │   ...    │  ...   │   ...   │  ...   │ │
│ └─────────────────────────────────────────────────────────────────────────┘ │
│                                                                              │
│                        [Sync All Approved (15 images)]                       │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```

### Per-Product Sync Detail
...
│ │       │ │       │ │       │ │       │ │       │ │       │ │       │     │
│ │ ✓SYNC │ │ ✓SYNC │ │ ✓SYNC │ │⏳PEND │ │⏳PEND │ │  ○    │ │  ○    │     │
│ └───────┘ └───────┘ └───────┘ └───────┘ └───────┘ └───────┘ └───────┘     │
│                                                                              │
│ ✓ Synced (3)  ⏳ Pending Sync (2)  ○ Not Approved (2)                       │
│                                                                              │
│ Actions:                                                                     │
│ [Remove from Store] - Only available for platform-synced images              │
│ [Approve Selected]  - Mark for sync                                          │
│ [Sync Now]          - Push pending to store                                  │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
- **Sync History**: Full audit trail in `store_sync_log`
...
│   └─────────────────────────────────────────────────────────────────────┘   │
│                                                                              │
│   Supported columns: name, sku, description, category, price, image_url     │
│   Max file size: 10MB                                                        │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
│  ├────────────────────────────────────────────────────────────────────────┤ │
│  │ Modern Desk       │ DSK-001  │ Desks       │ https://...               │ │
│  │ Office Chair      │ CHR-001  │ Chairs      │ https://...               │ │
│  └────────────────────────────────────────────────────────────────────────┘ │
│                                                                              │
│                                               [Back]    [Continue →]        │
│                                                                              │
...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  ✓ 45 products ready to import                                              │
│  ⚠ 3 warnings (will still import):                                          │
│     - Row 12: Missing description                                            │
│     - Row 28: Invalid price format, using 0                                  │
│     - Row 33: Duplicate SKU, will update existing                            │
│  ✗ 2 errors (will skip):                                                    │
│     - Row 7: Missing required field 'name'                                   │
│     - Row 19: Invalid image URL                                              │
│                                                                              │
│  [Download Error Report]                                                     │
│                                                                              │
│  Plan limit: 42 of 100 products imported                                     │
│  After import: 87 of 100 products                                            │
│                                                                              │
│                                               [Back]    [Import 45 Products] │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
│                         Welcome to Scenergy!                                │
│                                                                              │
│   We've set up some sample products and generations to help you explore.    │
│                                                                              │
│   ┌───────┐  ┌───────┐  ┌───────┐  ┌───────┐  ┌───────┐                    │
│   │ Sample│  │ Sample│  │ Sample│  │ Sample│  │ Sample│                    │
│   │ Desk  │  │ Sofa  │  │ Chair │  │ Lamp  │  │ Rug   │                    │
│   └───────┘  └───────┘  └───────┘  └───────┘  └───────┘                    │
│                                                                              │
...
4. **Studio** - "This is where the magic happens. Configure style and generate images."
5. **Assets Gallery** - "Browse all your generated images. Approve, download, or sync to store."
...
- Does not count against product limits
...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  Preset Name: [Living Room Modern Style________]                             │
│                                                                              │
│  Description: [Optional description...________]                              │
│                                                                              │
│  Settings to save:                                                           │
...
┌─────────────────────────────────────────────────────────────────────────────┐
│                                                                              │
│  💡 Using your previous settings for "Sofas"              [Reset to default] │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
│                                                                              │
│  ┌─────────────────────────────────────────────────────────────────────────┐│
│  │ ★ Living Room Modern (Default)                          [Edit] [Delete] ││
│  │   Scene: Living Room • Style: Modern • Lighting: Natural                ││
│  │   Last used: 2 days ago                                                 ││
│  ├─────────────────────────────────────────────────────────────────────────┤│
│  │   Bedroom Cozy                                          [Edit] [Delete] ││
│  │   Scene: Bedroom • Style: Scandinavian • Lighting: Warm                 ││
│  │   Last used: 1 week ago                                                 ││
│  ├─────────────────────────────────────────────────────────────────────────┤│
│  │   Office Professional                                   [Edit] [Delete] ││
│  │   Scene: Office • Style: Minimalist • Lighting: Natural                 ││
