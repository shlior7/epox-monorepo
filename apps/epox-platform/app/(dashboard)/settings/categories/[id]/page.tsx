  ...
  return (
    <>
      <PageHeader
        ...
        breadcrumb={
          <Link href="/settings/categories" className="flex items-center gap-1 hover:text-foreground transition-colors">
        ...
        <Card data-testid="category-default-bubbles-card">
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle>Default Bubbles</CardTitle>
                <CardDescription>
